		 ...
		 switch ($pesquisa) {
		 	...
		 	case 'Marketing':
		 		...
		 		echo " 
		 			...
		 			<strong>Uma das maiores dificuldades no início de qualquer empreendimento é a conquista dos clientes, mostrar o quanto sua ideia pode ser inovadora ou o quanto seu produto pode ser útil e sua qualidade surpreendente.<br>
					...
					Neste curso trabalhamos com o Marketing Direto, no qual os anúncios serão totalmente objetivos levando clientes (que estajam buscando por seu produto) até a sua página de vendas, canal, loja virtual ou física e página do Facebook.</strong>";
		 	break;
		 	...
		 	case 'Office':
					...
					<strong>Faculdade, cursos livres e técnicos<br>
					...
					Microsoft Office Essencial, apresenta a forma mais simples e rápida de aprender as principais ferramentas da Microsoft para a criação de Planilhas eletrônicas,<br> Formatação de Textos e Criação de Apresentações com os já conhecidos e amplamente utilizados Softwares Excel, Word e Power Point</strong>";
		 		break;
		 	...
		 	case 'Negocios':
		 		echo "
		 				...
		 				<strong>Já imaginou desenvolver um site e obter renda extra com isso?<br>
						...
						Se você disse sim para uma (ou todas) essas perguntas, então este curso é ideal!</strong>";
		 		break;
		
		 	default:
		 		echo "<h4> Desculpe Pesquisa Não Encontrada!<br> Clique Em Voltar Para  Acessar a Pagina Inicial </h4>";
		 		break;
		 }
